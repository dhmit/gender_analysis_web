...
class Document(models.Model):
    ...
    alias_dict = models.JSONField(null=True, blank=True, default=dict)
    character_dict = models.JSONField(null=True, blank=True, default=dict)
    ...
    def _clean_quotes(self):
        ...
        """
        self.cleaned_text = re.sub(r'[\“\”]', '\"', re.sub(r'[\‘\’]', '\'', self.text))
        self.save()
    ...
    def get_tokenized_text_wc_and_pos(self):
        ...
        """
        self._clean_quotes()
        tokens = nltk.word_tokenize(self.cleaned_text)
...
class Alias:
    ...
    def __init__(self, name, count, text_path=False, mentions=[], coref_clusters=[]):
        self.name = name
        self.count = count
        self.mentions = mentions
        self.coref_clusters = coref_clusters
        all_pronouns = self.calculate_pronouns()
        self.raw_pronouns = all_pronouns[0]
        self.pronoun_rates = all_pronouns[1]
        self.sanitized_pronoun_rates = all_pronouns[2]
